...
const PlayerEvangelion = ({audioElem, isplaying, setisplaying, currentSong, songs,currentSongIndex,setCurrentSongIndex})=> {
 ...
 const MuteSound=()=>{
  ...
  return (
    ...
    <div className='player_containerEvangelion'>
      <div className="title">
...
export default PlayerEvangelion