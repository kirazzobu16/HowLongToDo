...
import "./ListEvangelion.scss"
import "./HeaderEvangelion"
import { useEffect} from 'react'




function ListEvangelion({setDeleteToast}) {
  ...
  return (
    <div className='container Evangelion'>    
          {
              toDoList.map((item)=>(              
            <div className='list' >                        
                  <li className='flex' >
