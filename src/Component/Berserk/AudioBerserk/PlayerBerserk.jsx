...
const PlayerBerserk = ({audioElem, isplaying, setisplaying, currentSong, songs,currentSongIndex,setCurrentSongIndex})=> {
 ...
 const MuteSound=()=>{
  ...
  return (
    ...
    <div className='player_containerBerserk'>
      <div className="title">
