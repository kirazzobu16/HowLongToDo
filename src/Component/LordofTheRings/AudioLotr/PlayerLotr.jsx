...
const PlayerLotr = ({audioElem, isplaying, setisplaying, currentSong, songs,currentSongIndex,setCurrentSongIndex})=> {
 ...
 const MuteSound=()=>{
  ...
  return (
    ...
    <div className='player_containerLotr'>
      <div className="title">
