...
const PlayerStarWars = ({audioElem, isplaying, setisplaying, currentSong, songs,currentSongIndex,setCurrentSongIndex})=> {
 ...
 const MuteSound=()=>{
  ...
  return (
    ...
    <div className='player_containerStarWars'>
      <div className="title">
